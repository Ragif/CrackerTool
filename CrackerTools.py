...
header = """[[mg]]
  ...
  🔐[[bl]]  [5] [[yl]]Sha384      🔑[[bl]] [11] [[yl]]Decimal to Hexdecimal   🔑[[bl]] [17] [[yl]]Wd_List Clc
...
[[bl]]
  ...
  ║   [[grn]]                C0d3d by: Ragif Pashayev             [[bl]]                ║
  ╚────────────────────────────────────────────────────────────────────────╝ 

  ╔────────────────────────────────────────────────────────────────────────╗
  ║[[yl]] 🔐 MD  5    [[bl]]  All Directional Attack                                   ║
  ║[[yl]] 🔐 SHA 1    [[bl]]  First: Enter Hash: 5d009dd44f7c195fd61d8e46a9ae0bd8      ║
  ║[[yl]] 🔐 SHA 224  [[bl]]  Second  Enter your wordlist file: C:\wd.txt              ║
  ║[[yl]] 🔐 SHA 256  [[bl]]  That's all Very easy                                     ║
  ║[[yl]] 🔐 SHA 384  [[bl]]  This program is made suitable for android termux         ║
  ║[[yl]] 🔐 SHA 512  [[bl]]  You can send complaints and offers by email.             ║
  ╚────────────────────────────────────────────────────────────────────────╝
  ╔────────────────────────────────────────────────────────────────────────╗
  ...
  ║ [[yl]]🔑 Decode Ascii  [[bl]] Enter Ascii convert to utf-8 but use a space         ║
  ...
  ║                 Result:[[grn]] 16 ^ 5 =  1048576 [[bl]]this is  = [[grn]]1.048.576 [[bl]]more    ║
  ║                 than a million words                                   ║
  ║ [[yl]]🔑 Wd_List clc[[bl]]  Number: [[grn]]Million 10⁶[[bl]] this is a number type              ║
  ║                 Number of [[grn]]characters: 7[[bl]] how many character             ║
  ║                 have in million? of course 7                           ║
  ║                 and [[grn]]1.048.576[[bl]] words how much [[grn]]Storage[[bl]] space will it use?║
...
def wdClc():
  ...
  ╚─────────────────────────────────────────────────────────────────────────╝
    ...
    while True:
        wd_number = input(colorText("[[cyn]]⇨ How many numbers are in your wordlist?: "))
        wd_min_lenght = input(colorText("[[cyn]]⇨ Min wordlist length: "))
        wd_max_lenght = input(colorText("[[cyn]]⇨ Max wordlist length: "))
        print()
        if not wd_number:
            break
        try:
